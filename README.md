...
**Incident Report link.** A 4th per-race external link, alongside iRacing Results / Replay / Broadcast, editable from the same "Edit links" popover (`race_links.incident_report_url`, `0014_penalties.sql`).
